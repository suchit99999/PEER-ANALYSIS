...
import pandas as pd
import plotly.graph_objects as go
from dash import Dash, dcc, html, dash_table  # <-- Added dash_table import
...
# Load your table data (replace this with your actual DataFrame load)
